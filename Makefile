.PHONY: all setup build build_simulation bundle bundle_simulation clean clean_robot_build clean_robot_bundle clean_simulation_build clean_simulation_bundle
.DEFAULT_GOAL := all
